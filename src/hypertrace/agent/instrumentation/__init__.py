                ...
                if len(content_type_header_tuple) > 0:
                    ...
                    if content_type_header_tuple[0][1] is not None\
                        ...
                        if self.is_interesting_content_type(content_type_header_tuple[0][1]):
                            ...
                            request_body_has_been_truncated = False
                            if isinstance(request_body, bytes):
                                request_body_str = request_body.decode('UTF8')
                            else:
                                request_body_str = request_body
                                (request_body_has_been_truncated, request_body_str) = self.grab_first_n_bytes(
                                    request_body_str)
                            ...
                            if request_body_has_been_truncated:
                                span.set_attribute(
                                    self.HTTP_REQUEST_BODY_PREFIX + '.truncated', True)
                ...
                if len(content_type_header_tuple) > 0:
                    ...
                    if content_type_header_tuple[0][1] is not None\
                        ...
                        if self.is_interesting_content_type(content_type_header_tuple[0][1]):
                            ...
                            response_body_has_been_truncated = False
                            ...
                            if isinstance(response_body, bytes):
                                ...
                                (response_body_has_been_truncated, response_body_str) = self.grab_first_n_bytes(
                                    response_body_str)
                            ...
                            if response_body_has_been_truncated:
                                span.set_attribute(
                                    self.HTTP_RESPONSE_BODY_PREFIX + '.truncated', True)
    ...
    def generic_rpc_response_handler(self,
        ...
        try:
            ...
            if self.get_process_response_body():
                ...
                if response_body_has_been_truncated:
                    span.set_attribute(
                        self.RPC_RESPONSE_BODY_PREFIX + '.truncated', True)
