...
async def test_run():
  ...
  async with aiohttp.ClientSession() as session:
    async with session.post('http://localhost:8000/route1', data='{ "a":"a","xyz":"xyz" }', headers={ "Accept":"application/json", "Content-Type": "application/json", 'tester1': 'tester1', 'tester2':'tester2' }) as response:
      ...
      assert aiohttpSpanAsObject['attributes']['http.url'] == 'http://localhost:8000/route1'
