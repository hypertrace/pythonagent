...
def test_run():
    ...
    with agent.edit_config() as config:
        config.service_name = "test override service name"
    ...
    with app.test_client() as c:
        try:
            ...
            # assert the name override succeeded
            assert flaskSpanAsObject["resource"]["service.name"] == "test override service name"
