...
def test_run():
    ...
    def testAPI1():
        ...
        response = requests.get(
            url='http://localhost:8000/route2', headers=headers)
    ...
    with app1.test_client() as c:
        try:
            ...
            r1 = app1.test_client().get('http://localhost:5000/route1',
            ...
            logger.info('requestsSpanAsObject: ' +
                        json.dumps(requestsSpanAsObject))
